...
def main():
    ...
    _console.print("  [bold]/model[/bold] — ganti model  |  [bold]/sesi[/bold] [bold]/lihat[/bold] [bold]/baru[/bold] [bold]/keluar[/bold]", style="dim")
    _console.rule(style="dim")
    ...
    cmd_completer = WordCompleter(['/model', '/sesi', '/lihat', '/baru', '/keluar', '/sessions', '/view', '/new', '/exit', '/reload', '/reset_quota'])
